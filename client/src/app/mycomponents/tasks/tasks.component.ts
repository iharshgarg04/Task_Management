...
export class TasksComponent {
  ...
  fetchData(userId:string):void{
    this.isLoading =true;
    this.http.get(`https://task-management-server-omega-six.vercel.app/task/fetchMyTask/${userId}`).subscribe((res:any)=>{
  ...
  handleDelete(taskId:string){
    ...
    if(userId){
      ...
      console.log(parsed);
      this.isLoading = true;
      this.http.delete(`https://task-management-server-omega-six.vercel.app/task/deleteTask/${taskId}?userId=${parsed._id}`,).subscribe((res:any)=>{
        this.fetchData(parsed._id);
        console.log(res);
        this.isLoading =false;
  ...
  handleStatus(taskId:string){
    ...
    if(userId){
      ...
      this.isLoading =true;
      console.log(payload)
      this.http.put("https://task-management-server-omega-six.vercel.app/task/updateStatus",payload).subscribe((res:any)=>{
        this.fetchData(parsed._id);
